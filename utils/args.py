...
def parser_args():
    ...
    parser.add_argument('--log_dir', type=str, default='LOG_SOV',
                        help='the saving dir of logs')
    parser.add_argument('--seed', type=int, default=0,
                        help='the seed mark of training')
    ...
    parser.add_argument('--iid', action='store_true', default =True,
                        help='dataset is splited iid or not')
    parser.add_argument('--beta', type=float, default=1.0,
                         help="non_iid parameter")    
    ...
    parser.add_argument('--num_sign', type=int, default=10,
    ...
    parser.add_argument('--num_bit', type=int, default=1024,
    ...
    parser.add_argument('--defence_type', default=None, choices=['median', 'trimmed', 'krum'],
                        help='byz_defence_type')
    parser.add_argument('--byz_attack', default=None, choices=['gaussion', 'label_flipping'],
                        help='byz_attack_type')    

    parser.add_argument('--num_byz', type=int, default=0,
                        help='the number of byz atttackers in clients')
